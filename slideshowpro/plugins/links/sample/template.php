<?php
	...
	*/
	...
	/*
		...
		available for the image. e.g. http://www.myhost.com/slideshowpro/albums/album-1/hr/myimage.jpg
		...
		[img_id] = the database ID for the image
	*/
	
	$template = '[full_hr_url]';
	
	/*
		The target variable defines whether the link will open in a new window (0), 
		the same browser window as the slideshow (1), or the parent frame (2).
